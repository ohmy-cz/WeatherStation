...
namespace net.jancerveny.weatherstation.Common.Helpers
{
    public static class Colors
    {
        public static ColorRGBA[] ColorsList => new ColorRGBA[] {
            ...
            new ColorRGBA(81, 134, 140, 0.2F),
            new ColorRGBA(165, 153, 137, 0.2F),
            new ColorRGBA(114, 74, 51, 0.2F),
            new ColorRGBA(216, 148, 108, 0.2F),
            new ColorRGBA(63, 38, 28, 0.2F)
        };
        ...
        public static ColorRGBA ThirdPartyWeatherFeelsLike => new ColorRGBA(120, 120, 120, 0.2F);
